...
const BlogHighlights: React.FC<BlogHighlightsProps> = ({ navigate }) => {
    ...
    return (
        <section id="blog-highlights" className="py-24 relative bg-[#0a101f] overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {latestPosts.map((post, index) => (
                        <a 
                            ...
                            className="group bg-white/[0.02] rounded-3xl overflow-hidden border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-500 hover:shadow-2xl hover:shadow-[#F6520C]/5 flex flex-col h-full"
                        ...
                        >
                            <div className="relative h-56 overflow-hidden m-2 rounded-2xl">
                                ...
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-[#0a101f] to-transparent opacity-80"></div>
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                <h3 className="text-xl font-bold text-white mb-4 line-clamp-2 tracking-tight group-hover:text-[#F6520C] transition-colors">
                                    {post.title}
                                </h3>
