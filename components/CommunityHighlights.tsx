    ...
    return (
        <section id="community-highlights" className="py-24 relative bg-[#050810] overflow-hidden">
            ...
            <motion.div 
                ...
                className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[120px] pointer-events-none"
            ></motion.div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        {author && (
                                            <motion.img 
                                                ...
                                                src={generateAvatarUrl(author.avatarConfig)} 
                                                alt={author.name} 
