...
const values = [
    { title: 'Student-Centric', description: 'Our students are at the heart of everything we do. Their success is our success.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#F6520C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg> },
    { title: 'Data-Driven', description: 'We leverage technology and data to provide the most accurate and personalized guidance.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#F6520C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" /></svg> },
    { title: 'Integrity', description: 'We believe in transparent, honest, and ethical guidance throughout the entire process.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#F6520C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg> },
    { title: 'Innovation', description: 'We are constantly evolving and building new tools to make the study abroad journey seamless.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#F6520C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg> },
];
                    ...
                    <section className="mb-24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {platformFeatures.map((feature, index) => (
                                <div key={feature.title} className="bg-white/5 backdrop-blur-sm p-8 rounded-lg border border-gray-700 hover:border-[#F6520C] hover:-translate-y-2 transition-all duration-300 animate-fade-in flex flex-col" style={{ animationDelay: `${index * 0.1}s` }}>
                    ...
                    <section className="mb-24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {values.map((value, index) => (
                                <div key={value.title} className="bg-gray-800/50 p-6 rounded-lg flex flex-col items-center text-center animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                                    <div className="mb-4 bg-gray-900/50 p-3 rounded-full">{value.icon}</div>
