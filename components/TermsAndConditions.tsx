      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <div className="bg-white/[0.02] backdrop-blur-md p-8 md:p-12 rounded-3xl border border-white/5 shadow-2xl">
          ...
          <div className="text-gray-300 space-y-8 text-left leading-relaxed font-light">
            ...
            <div className="space-y-4">
                <h2 className="text-2xl font-bold text-white tracking-tight flex items-center gap-3">
                    <span className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-sm text-blue-400 font-bold border border-white/10">8</span> 
                    Changes to Terms
                </h2>
            ...
            <div className="space-y-4">
                <h2 className="text-2xl font-bold text-white tracking-tight flex items-center gap-3">
                    <span className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-sm text-blue-400 font-bold border border-white/10">9</span> 
                    Governing Law
                </h2>
            ...
            <div className="space-y-4 pt-8 border-t border-white/10">
                ...
                <p>If you have any questions about these Terms, please contact us at <a href="mailto:hello@gradniche.com" className="text-blue-400 hover:text-blue-300 transition-colors font-medium">hello@gradniche.com</a>.</p>
            </div>
          </div>
        </div>
      </div>
