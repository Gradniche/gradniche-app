...
const CostChart = () => {
    ...
    return (
        <div className="bg-gray-900/60 backdrop-blur-xl p-8 rounded-3xl border border-white/10 my-16 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600/5 rounded-full blur-[80px] -z-10 group-hover:bg-blue-600/10 transition-colors duration-700"></div>
            ...
            <ResponsiveContainer width="100%" height={400}>
                <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    ...
                    <Bar dataKey="Food" stackId="a" fill="#8b5cf6" />
...
const BlogDetail: React.FC<BlogDetailProps> = ({ blog, onBack, navigate }) => {
    ...
    return (
        <section className="bg-[#050a14] min-h-screen relative overflow-hidden">
            {/* Background Effects */}
            ...
            <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[150px] pointer-events-none"></div>
            ...
            <div className="container mx-auto px-6 max-w-4xl pt-32 pb-24 relative z-10">
                ...
                <article className="animate-fade-in">
                    <header className="mb-16 text-center">
                        <div className="inline-block px-4 py-1.5 mb-8 text-xs font-bold tracking-widest text-blue-400 uppercase bg-blue-600/10 border border-blue-500/20 rounded-full">
                            {blog.category}
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-400 font-medium">
                            <span className="flex items-center bg-white/5 px-4 py-2 rounded-full border border-white/10">
                                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 mr-3 shadow-sm"></div>
                    ...
                    <div className="rounded-[2rem] overflow-hidden mb-16 shadow-2xl shadow-black/50 border border-white/10 relative">
                        <div className="absolute inset-0 bg-gradient-to-t from-[#050a14] to-transparent opacity-40 z-10"></div>
                        <img src={blog.image} alt={blog.title} className="w-full h-auto object-cover max-h-[600px]" />
                    </div>

                    <div className="prose prose-lg prose-invert mx-auto max-w-none text-gray-300 leading-relaxed font-light prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-white prose-a:text-blue-400 hover:prose-a:text-blue-400 prose-strong:text-white prose-strong:font-semibold">
                    ...
                    <div className="mt-20 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="flex space-x-4">
                            <button className="p-3 bg-white/5 border border-white/10 rounded-full hover:bg-blue-600 hover:border-blue-500 hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-1">
