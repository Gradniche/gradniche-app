  ...
  return (
    <section className="py-24 relative bg-[#050a14] min-h-screen overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <div className="bg-white/[0.02] backdrop-blur-2xl p-8 md:p-12 rounded-[32px] border border-white/5 shadow-2xl">
          <div className="text-center mb-12">
              <div className="inline-block px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-6">
                  <span className="text-xs font-semibold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 uppercase">Legal</span>
              </div>
          ...
          <div className="text-gray-300 space-y-8 text-left leading-relaxed font-light">
            ...
            <div className="space-y-4">
                ...
                <div className="pl-11 space-y-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-400 marker:text-blue-500">
                      <li>
            ...
            <div className="space-y-4">
                ...
                <div className="pl-11 space-y-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-400 marker:text-blue-500">
                      <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">Google Chrome</a></li>
                      <li><a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">Mozilla Firefox</a></li>
                      <li><a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">Apple Safari</a></li>
                      <li><a href="https://support.microsoft.com/en-us/windows/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">Microsoft Edge</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div className="space-y-4 pt-8 border-t border-white/10">
                ...
                <p>If you have any questions about our use of cookies, please email us at <a href="mailto:hello@gradniche.com" className="text-blue-400 hover:text-blue-300 transition-colors font-medium">hello@gradniche.com</a>.</p>
            </div>
          </div>
        </div>
      </div>
