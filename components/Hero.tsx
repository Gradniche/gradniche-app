...
const Hero: React.FC<HeroProps> = ({ navigate }) => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 pb-24 bg-[#050810]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-[#F6520C]/20 rounded-full blur-[140px]"
        />
        <motion.div 
          animate={{
            x: mousePos.x * 1.2,
          ...
          className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-blue-500/15 rounded-full blur-[140px]"
        />
      </div>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none hidden lg:block">
        ...
        <motion.div 
          ...
          className="absolute top-[15%] left-[5%] xl:left-[10%] w-56 h-72 rounded-3xl border border-white/10 p-2 bg-white/5 backdrop-blur-md shadow-2xl"
        >
        ...
        <motion.div 
          ...
          className="absolute top-[20%] right-[5%] xl:right-[10%] w-64 h-48 rounded-3xl border border-white/10 p-2 bg-white/5 backdrop-blur-md shadow-2xl"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[15%] left-[8%] xl:left-[12%] w-64 h-48 rounded-3xl border border-white/10 p-2 bg-white/5 backdrop-blur-md shadow-2xl"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[20%] right-[8%] xl:right-[12%] w-56 h-72 rounded-3xl border border-white/10 p-2 bg-white/5 backdrop-blur-md shadow-2xl"
        >
      ...
      >
        ...
        <div className="text-center max-w-4xl mx-auto mb-10 md:mb-12">
          <motion.div variants={itemVariants} className="inline-block px-4 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-6">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl lg:text-9xl font-bold tracking-tight mb-6 text-white" 
          ...
          <motion.p 
            variants={itemVariants}
            className="text-lg md:text-2xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed px-4"
          >
        ...
        <motion.div 
          variants={itemVariants}
          className="w-full max-w-4xl mx-auto bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-2 shadow-2xl"
        >
          <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-2">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full md:w-auto px-8 py-4 bg-[#F6520C] hover:bg-[#d44306] text-white rounded-2xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(246,82,12,0.3)]"
            >
              Search
