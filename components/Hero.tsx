  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 max-w-4xl mx-auto" style={{ textShadow: '0px 2px 10px rgba(0, 0, 0, 0.5)' }}>
        ...
        <a 
          ...
          className="bg-[#F6520C] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-opacity-90 transition-all duration-300 shadow-lg transform hover:scale-105 glow-border focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-offset-black/50 focus:ring-[#F6520C]/80"
        >
