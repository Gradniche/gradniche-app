            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                <div className="text-center mb-16">
                    <div className="inline-block px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-6">
                        <span className="text-xs font-semibold tracking-widest text-blue-400 uppercase">Preparation</span>
                    </div>
                ...
                <div className="bg-white/[0.02] backdrop-blur-md p-8 sm:p-10 rounded-3xl border border-white/5 shadow-2xl">
                    <div className="mb-10">
                        ...
                        <div className="w-full bg-white/5 rounded-full h-3 relative overflow-hidden border border-white/10">
                            <div
                                className="bg-gradient-to-r from-blue-500 to-pink-600 h-full rounded-full transition-all duration-1000 ease-out relative"
                                    ...
                                    >
                                        <div className="flex items-center space-x-5">
                                            ...
                                            <div className="text-left">
                                                <h3 className={`text-xl font-bold tracking-tight transition-colors ${isCategoryComplete ? 'text-gray-500 line-through' : 'text-white group-hover:text-blue-400'}`}>{category.title}</h3>
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 text-gray-500 transition-transform duration-500 ${isCategoryOpen ? 'rotate-180 text-blue-400' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                                        </div>
                                    </button>
                                             ...
                                             <div className="p-6 pt-0 border-t border-white/5 space-y-3 mt-2" onDragLeave={() => setDragOverItemId(null)}>
                                                {category.items.map(item => (
                                                    <div key={item.id} className="relative">
                                                        {dragOverItemId === item.id && <div className="absolute -top-2 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-pink-500 rounded-full z-10" />}
                                                        <label
                                                            htmlFor={item.id}
                                                            draggable
                                                        ...
                                                        >
                                                            ...
                                                            <div className="relative flex items-center justify-center">
                                                                ...
                                                                />
                                                                <div className="w-6 h-6 rounded border-2 border-gray-500 flex-shrink-0 flex items-center justify-center peer-checked:bg-gradient-to-br peer-checked:from-blue-500 peer-checked:to-pink-600 peer-checked:border-transparent transition-all duration-300 shadow-inner">
                    ...
                    <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-6">
                        <button onClick={resetChecklist} className="text-gray-400 text-sm font-medium hover:text-purple-400 transition-colors bg-white/5 hover:bg-white/10 px-6 py-3 rounded-full border border-white/10 w-full sm:w-auto">
                           Reset Checklist
                        </button>
